...
SECRET_KEY = os.environ.get(
    'SECRET_KEY', 'django-insecure-87+!+j8ywsv54we9o4x$+t%bnlo-9u+g_0+3@dlfnuf8y(cbu7')
...
DATABASES = {
    'default': {
        ...
        'NAME': 'neondb',
        'USER': 'neondb_owner',
        'PASSWORD': 'npg_ukC5qtLBJW1V',
        'HOST': 'ep-wandering-night-ap6hmp1o.c-7.us-east-1.aws.neon.tech',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        },
